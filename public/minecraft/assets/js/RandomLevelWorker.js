...
function ImprovedNoise(random) {
   ...
   this.getValue = function (d0, d1) {
      ...
      return lerp(
         ...
         lerp(
            d6,
            lerp(d5, grad(this.p[i1], d4, d3, d2), grad(this.p[j], d4 - 1.0, d3, d2)),
            lerp(d5, grad(this.p[l], d4, d3 - 1.0, d2), grad(this.p[i], d4 - 1.0, d3 - 1.0, d2)),
         ),
         lerp(
            d6,
            lerp(d5, grad(this.p[i1 + 1], d4, d3, d2 - 1.0), grad(this.p[j + 1], d4 - 1.0, d3, d2 - 1.0)),
            lerp(d5, grad(this.p[l + 1], d4, d3 - 1.0, d2 - 1.0), grad(this.p[i + 1], d4 - 1.0, d3 - 1.0, d2 - 1.0)),
         ),
      );
   };
}
      ...
      this.grow = function (aint) {
         ...
         for (var l = 0; l < i; ++l) {
            ...
            for (var i1 = 0; i1 < j; ++i1) {
               ...
               if (
                  (l1 = parseInt(this.tiles[((j1 + 1) * this.zSize + i1) * this.xSize + l], 10) & 255) == 7 &&
                  j1 <= k / 2 - 1 &&
                  flag1
               ) {
               ...
               for (var i2 = 0; i2 < 20; ++i2) {
                  ...
                  if (k1 >= 0 && l1 >= 0 && k1 < this.xSize && l1 < this.zSize) {
                     ...
                     if (flag) {
                        ...
                        if (
                           (this.tiles[((j2 - 1) * this.zSize + l1) * this.xSize + k1] & 255) == 1 &&
                           j2 < this.ySize - k2 - 1
                        ) {
